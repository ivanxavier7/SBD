...
CREATE TABLE `prescricao` (
  ...
  `nr_prescricao` int(11) NOT NULL,
  `descricao` longtext NOT NULL,
  PRIMARY KEY (`consulta_data`,`consulta_utente_numero`),
  CONSTRAINT `fk_prescricao_consulta1` FOREIGN KEY (`consulta_data`, `consulta_utente_numero`) REFERENCES `consulta` (`data`, `utente_numero`)
...
-- Dump completed on 2021-01-22 17:42:44
